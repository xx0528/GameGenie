 ...
 * @LastEditTime: 2023-03-29 17:31:34
 * @Description: 
 */
 ...
 * @example
GG.log.trace("默认标准日志")
GG.log.logConfig("灰色配置日志")
GG.log.logNet("橙色网络日志")
GG.log.logModel("紫色数据日志")
GG.log.logBusiness("蓝色业务日志")
GG.log.logView("绿色视图日志")
 */
export class Logger {
     ...
     * @example
GG.log.setTags(LogType.View|LogType.Business)
     */
...
GG.log.end()
     ...
     * @param describe  标题描述
     * @example
var object:any = {uid:1000, name:"GG"}
GG.log.table(object)
     */
